...
public class BjinfobankTitle {
	public static void main(String args[]) throws Exception {
		BjinfobankTitle test1 = new BjinfobankTitle();
		test1.readUrl();
	}
	
	public void readUrl() throws Exception {
		File input = new File("J:/crawl/stock_title.txt");
	...
	public void homePage(String line) throws Exception {
	    ...
	    try (final WebClient webClient = new WebClient()) {
	        String url = "http://www.bjinfobank.com/DataList.do?page=1&db=HK&rl=2&iw="+encode+"&query=TI&pageSize=100&endTime=&metiaName=&typeName=&starTime=&metiaLevel=&method=DataList&className=&areaForArt=&myorder=SUTM&areaForArt=";
	        ...
	        FileOutputStream out=new FileOutputStream("J:\\crawl\\output\\bjinfobank_title\\"+line+".csv");
	        ...
	        for(int j = 2; j <= pageNum; j++) {
	        	String url2 = "http://www.bjinfobank.com/DataList.do?page="+j+"&db=HK&rl=2&iw="+encode+"&query=TI&pageSize=100&endTime=&metiaName=&typeName=&starTime=&metiaLevel=&method=DataList&className=&areaForArt=&myorder=SUTM&areaForArt=";
